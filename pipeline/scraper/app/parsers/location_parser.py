...
def parse_location(soup: BeautifulSoup, source_url: str, scraped_at: str | None = None) -> dict:
    ...
    return {"frontmatter": frontmatter, "body": f"# {name}", "slug": f"location-{slug(name)}"}
